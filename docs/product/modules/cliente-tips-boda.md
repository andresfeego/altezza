...
- tipo de evento (boda, quince años, etc.)
- categoría (para novia, para novio, para padres, consejos generales, etc.)

El objetivo de este módulo es ofrecer **contenido útil, consejos y mensajes motivacionales** para los dueños del evento durante el proceso de planificación.
