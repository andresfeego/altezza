...
- **Cliente → Altezza:** los clientes también pueden crear pendientes dirigidos al equipo de Altezza (por ejemplo dudas, solicitudes o recordatorios).

Cada pendiente mantiene la referencia de **quién lo creó** y su **estado de avance**, permitiendo llevar seguimiento de las tareas relacionadas con la planeación del evento.
