# Altezza (MiEvento) — Índice de producto (LAB)
...
- [Módulos](#módulos)
  - [Admin](#admin)
  - [Cliente](#cliente)
  - [Organizador (propuesto)](#organizador-propuesto)
  - [Colaborador (propuesto)](#colaborador-propuesto)
- [Sistema](#sistema)
...
- Ver: [system/comportamientos.md](system/comportamientos.md)
