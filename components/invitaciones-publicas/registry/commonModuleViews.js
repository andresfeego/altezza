...
import RecommendationsView from '../module-views/RecommendationsView';
...
import ImageSlider1View from '../module-views/ImageSlider1View';
...
export const COMMON_MODULE_VIEWS = {
  ...
  image_slider_1: ImageSlider1View,
